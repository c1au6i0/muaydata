...
ADD Health
https://www.icpsr.umich.edu/icpsrweb/content/DSDR/add-health-data-guide.html
https://www.cpc.unc.edu/projects/addhealth/documentation/ace/tool/topics
...
toselect <- which(map(prova, function(x) ncol(x) > 0) == TRUE)
heal_data <- plyr::join_all(prova[toselect] , by = "AID", type = "inner")

```
#-------------------
<!-- Classifiers:----------------------------------------------- -->
<!-- https://www.cpc.unc.edu/projects/addhealth/documentation/ace/tool/variablecollection?VariableCollectionId=2164 -->
<!-- https://www.cpc.unc.edu/projects/addhealth/documentation/ace/tool/variablecollection?VariableCollectionId=2182 -->
<!-- https://www.cpc.unc.edu/projects/addhealth/documentation/ace/tool/variablecollection?VariableCollectionId=2185 -->
<!-- https://www.cpc.unc.edu/projects/addhealth/documentation/ace/tool/variablecollection?VariableCollectionId=2206 -->
<!-- https://www.cpc.unc.edu/projects/addhealth/documentation/ace/tool/variablecollection?VariableCollectionId=2474 -->
<!-- https://www.cpc.unc.edu/projects/addhealth/documentation/ace/tool/variablecollection?VariableCollectionId=2161 -->
<!-- https://www.cpc.unc.edu/projects/addhealth/documentation/ace/tool/variablecollection?VariableCollectionId=2190 -->
