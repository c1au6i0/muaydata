...
Disegneremo il grafico con  *ggplot* ma prima sarà necessario ordinare per ognin politico i livelli della colonna *word* a seconda di quella delle percentuali *perc* (grazie [MrFlick](https://stackoverflow.com/questions/48179726/ordering-factors-in-each-facet-of-ggplot-by-y-axis-value))
...
__Per Salvini e Martina la parola più usata è il proprio nome/screenname__, mentre per __Di Maio è il partito__ "m5s". __Salvini menziona il suo nome in circa 1 tweets ogni 3, Martina e Di Maio menziona  nome e partito in 1 tweet ogni 10 , rispettivamente__.
...
I temi in comune tra i 3 politici sono la patria (*italia*), il presente (*ora*) e il...__partito democratico __(*pd*). I sostenitori del m5s sono stati spesso bersaglio di satira per l'uso considerato eccessivo di riferimenti e comparazioni con il PD [link](https://www.lercio.it/maturita-al-posto-della-soluzione-scrive-e-allora-il-pd-e-passa-la-prova-di-matematica/)
