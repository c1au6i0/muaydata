...
Andiamo finalmente a rappresentare graficamente le 7 parole più usate da Di Maio in funzione del tempo, oer gli ultimi 3 anni.
...
```{r fig.3_timeline_dimaioa, fig.width=3, fig.height=3}
  ...
  labs(x = NULL, y = NULL, col = NULL, group = NULL, title = "Di Maio - Percent tweets", caption= "  ") +
  theme(plot.title = element_text(hjust = 0.5)) 
```
